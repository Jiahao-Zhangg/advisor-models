...
mkdir -p "$ADVISOR_MODELS_ROOT/ckpts/reviews_length"

# Run training
"$ADVISOR_MODELS_ROOT/SkyRL/skyrl-train/.venv/bin/python" -m advisor_models.reviews.main_reviews_length \
  ...
  trainer.ckpt_path="$ADVISOR_MODELS_ROOT/ckpts/reviews_length"
